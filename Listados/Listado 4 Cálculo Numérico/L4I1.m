...
[x1,y1] = eulerExplicito(y1_0,a1,b1,f1,n);
x_exacta1 = linspace(a1,b1,n);
...
[x2,y2] = eulerExplicito(y2_0,a2,b2,f2,n);
x_exacta2 = linspace(a2,b2,n);
...
[x3,y3] = eulerExplicito(y3_1,a3,b3,f3,n);
x_exacta3 = linspace(a3,b3,n);
y_exacta3 = x_exacta3.*(1+log(x_exacta3));

figure(3)
plot(x3,y3,"or",x_exacta3,y_exacta3,"-b")
